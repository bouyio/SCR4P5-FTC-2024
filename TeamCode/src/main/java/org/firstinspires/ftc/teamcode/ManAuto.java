...
@Autonomous()
public class ManAuto extends OpMode {
    ...
    final double MAXAUTOSPEED = 0.3;   //  Clip the approach speed to this max value (adjust for your robot)
    final double MAXAUTOSTRAFE = 0.3;   //  Clip the approach speed to this max value (adjust for your robot)
    ...
    public void start(){
        ...
        currentSelection = PropReco.Selected.MIDDLE;
       ...
       /*  while(!arrivedToTarget){
            searchForTag(desiredTagId);
             telemetry.addData("", arrivedToTarget); */
    }
