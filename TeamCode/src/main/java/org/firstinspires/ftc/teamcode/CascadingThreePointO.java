...
@TeleOp()
public class CascadingThreePointO extends OpMode {
    ...
    Servo clawL;
    Servo clawR;
    boolean liftRotateLock = false;
    double powerLiftRotationLock;
    double powerLiftRotateL;
    double powerLiftRotateR;
    @Override
    public void init() {
    ...
    @Override
    public void loop() {
        if(!liftRotateLock && gamepad1.dpad_down){
            liftRotateLock = gamepad1.dpad_down;
            powerLiftRotationLock = gamepad1.left_stick_y * 0.5;
            powerLiftRotateL = powerLiftRotationLock;
            powerLiftRotateR = powerLiftRotationLock;
        } else {
            powerLiftRotateL = gamepad1.left_stick_y * 0.5;
            powerLiftRotateR = gamepad1.left_stick_y * 0.5;
        }



        cascadeRotateL.setPower(powerLiftRotateL);
        cascadeRotateR.setPower(powerLiftRotateR);
